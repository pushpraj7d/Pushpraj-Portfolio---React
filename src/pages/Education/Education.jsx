...
const EducationSection = () => {
  ...
  const educationData = [
  {
    ...
    school: "St. Francis Convent School",
    mascot: "📘",
    year: "2010 - 2020",
    achievements: ["Percentage: 92%", "Board: State Board"],
  ...
  },
  {
    ...
    mascot: "📗",
    year: "2020 - 2022",
    achievements: ["Percentage: 75%", "Stream: Physics, Chemistry, Maths"],
  ...
  },
  {
    ...
    mascot: "🎓",
    year: "2022 - Present",
    achievements: ["CGPA: 6.5", "Branch: CSE (AI & ML)"],
