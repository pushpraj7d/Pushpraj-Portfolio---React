...
const profile = {
    name: 'Pushpraj Singh',
    title: 'Frontend Developer | React Specialist | Java DSA Practitioner',
    skills: [
        'ReactJS', 'Redux', 'Tailwind CSS', 'GSAP', 
        'Locomotive JS', 'HTML', 'JavaScript', 'Java', 
        'Git', 'DSA' , 'VS Code', 'Animations'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/pushpraj7d"
                ...
                <a
                  href="https://www.linkedin.com/in/pushpraj-singh-rajput/"
                  className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 p-0.5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-teal-400">
                    <span className="relative flex items-center justify-center gap-2 text-white font-medium">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1hrFICHB_bqai8VFJbVRD-OtdT79_W_EC/view?usp=drivesdk"
